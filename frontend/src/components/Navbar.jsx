          ...
          <div className="hidden md:flex items-center gap-8">
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/staff-login"
                  className="px-6 py-2.5 border border-blue-500 text-blue-300 rounded-lg hover:bg-blue-600/30 transition-all duration-300 font-semibold"
                >
                  Staff Login
                </Link>
              </>
            ...
            {isAuthenticated ? (
              ...
              <>
                ...
                <Link
                  to="/staff-login"
                  onClick={() => setIsOpen(false)}
                  className="block text-center border border-blue-500 text-blue-300 hover:bg-blue-600/30 px-4 py-3 rounded-lg transition-all duration-300"
                >
                  Staff Login
                </Link>
              </>
